...
// Rotation2d getCorrectionAimingAngleByVelocity(double shootAngle, double deltaHeight, Translation2d targetPosition, Translation2d robotPosition, ChassisSpeeds robotVelocity);
